    ...
    <div className="mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <p className="text-3xl font-bold text-gray-900">¥{totalMonthly.toFixed(0)}</p>
        </div>
        
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <h3 className="text-sm font-medium text-gray-600 mb-2">年間予想</h3>
          <p className="text-3xl font-bold text-gray-900">¥{yearlyTotal.toFixed(0)}</p>
        </div>
        
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <h3 className="text-sm font-medium text-gray-600 mb-2">サービス平均</h3>
          <p className="text-3xl font-bold text-gray-900">¥{averagePerService.toFixed(0)}</p>
        </div>
      </div>
